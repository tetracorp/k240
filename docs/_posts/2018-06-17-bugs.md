...
July 1994 v2.000 update. This appears to be the only change
...
![Plasma Turret](../images/buildings/plasma-turret.png "Plasma Turret")<br>![Photon Turret](../images/buildings/photon-turret.png "Photon Turret")
{:.right}
...
two should correctly be spelled Français and Deutch.
