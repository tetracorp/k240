...
: A ship called the Orbital Shuttle appears in the code, and can be edited in.
However, we don't know its original purpose, what its statstics were supposed to
be, or why it was removed.
