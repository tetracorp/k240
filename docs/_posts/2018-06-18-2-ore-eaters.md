...
Launch Facility
: Construction Yard. Required to build ships. Caps out at two launch facilities.
Each is used to construct an Orbital Space Dock.
...
Rocket Battery
: ![ore_missile_silo_anim](../images/alien_ships/ore_missile_silo_anim.gif "ore_missile_silo_anim"){:.left} Required to launch or build missiles.
...
An immobile diamond-shaped ship with 50 Armour and no hardpoints. Purpose
unknown. Never built randomly.
