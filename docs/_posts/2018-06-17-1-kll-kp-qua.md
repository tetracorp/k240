...
! have a hard cap instead) and the equivalent position in the Terran building
list.
...
Queen's Chamber
: The strongest building in the game, Terran or alien. Equivalent to the Terran
Command Centre, not a CPU: aliens build clusters of four buildings to start
colonies, and only Terrans use a CPU (to give the player the maximum opportunity
to build his own colony, most likely). If the Queen's Chamber is destroyed, the
colony is destroyed.
...
* Next event: Reinforcements (60 days; although if the player has not entered
  Manual Code, that event will precede it)
...
Every other day, as long as there is at at least Mine, and least one of either
Power Collector or Power Convertors, the Kll'Kp'Qua can mine. They mine one unit
of five randomly chosen ores. They do not need Ore Storage Chamber to mine, nor
does anything track the amount of ore they have mined, although it will deplete
the asteroid of ore as normal.
...
that race, and causes a blue flash and rare sound. It __reduces the population
of the target asteroid by 20__. It is rarely a threat since they only have a 5%
chance to build one each time and only to a maximum of 5 per asteroid, meaning
it can only reduce your population by 100 per missile strike.

Trivia: 

* Kll-Kp-Qua are the only alien to use Napalm.
* The Kll'Kp'Qua is the only alien for whom Scatter is listed as High yield. All
  other aliens list is as Medium.
* They will not build Hellfire, Mega, Stasis or Antivirus.
...
Name                  | Armor | S | H | ID | <td colspan=6>Hardpoints
----------------------|------:|--:|--:|:---|----|----|----|----|----|----|
                      |    10 | 2 | 1 | 3c | 06 | 0b |    |    |    |    |
                      |    20 | 2 | 3 | 3d | 06 | 00 | 05 |    |    |    |
                      |    80 | 1 | 0 | 3e |    |    |    |    |    |    |
"Scoutship"           |    10 | 2 | 1 | 3f | 05 |    |    |    |    |    |
                      |    40 | 1 | 4 | 40 | 05 | 06 | 02 | 01 |    |    |
                      |    20 | 0 | 0 | 41 |    |    |    |    |    |    |
"Transporter"         |    20 | 0 | 2 | 42 | 00 | 07 |    |    |    |    |
"Battleship"          |    60 | 0 | 6 | 43 | 05 | 06 | 00 | 01 | 0a | 02 |

Ship $3c
: A small ship with 10 hit points and two hardpoints: a Photon Cannon (6 damage)
...
Ship $3d
: A small ship with 20 hit points. It has a Photon Cannon (6 damage), an Ion
Cannon, and a Laser Cannon (2 damage).
Ship $3e
: A ship with 80 hit points and no hardpoints. Unknown at this time. Its speed
and size suggest a larger ship.
Ship $3f
: A scout ship with 10 armor and one hardpoint, a Laser Cannon (2 damage).
Ship $40
: A larger combat ship with 40 armor and 4 hardpoints: a Laser Cannon (2
damage), Photon Cannon (6 damage), a Disruptor and a Napalm Orb.
Ship $41
: An immobile ship with no hardpoints. It has special code that has not yet been
analyzed.
Ship $42
: A transporter with 20 hit points and two hardpoints: an Ion Cannon, and a
Plasma Cannon (4 damage). Only ship of this race equipped with Plasma Cannon.
Ship $43
: A battleship with 60 hit points. Its six hardpoints are a Laser Cannon (2
damage), a Photon Cannon (6 damage), an Ion Cannon, a Disruptor, a Napalm Orb,
and a Deflector. The Deflector halves damage it takes, effectively giving it
120 hit points.
