...
Missile Bay
: ![kll_missile_silo_anim](../images/alien_ships/kll_missile_silo_anim.gif "kll_missile_silo_anim"){;.left}
...
Power Collector
: Must have one of these _or_ a Power Converters to mine ore.
...
A small ship with 10 Armour and two hardpoints: a Photon Cannon (6 damage)
