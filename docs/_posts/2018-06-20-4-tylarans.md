...
{:.right width="128px" height="126px"}
...
Control Centre
: ![Control Centre](../images/alien_bldg/tyl_control_centre.gif "control centre"){:.left} Colony must have at least one Control Centre or Habitat, or be destroyed.
...
Fleet Factory
: ![Fleet Factory](../images/alien_bldg/tyl_fleet_factory.gif "fleet factory"){:.left} A shipyard. A maximum of four per colony can operate. Requires either a Power
...
Power Collector
: ![Power Collector](../images/alien_bldg/tyl_power_collector.gif "power collector"){:.left} A powerplant. A Power Collector or Power Generator is required to build ships.
...
Thrusters
: ![Thrusters](../images/alien_bldg/tyl_thrusters.gif "thrusters"){:.left} Asteroid engines observed to allow travel at speeds of up to 8. Require at
...
Warp Manipulator
: ![Warp Manipulator](../images/alien_bldg/tyl_warp_manipulator.gif "warp manipulator"){:.left} Unknown Defence type building. Reacts to incoming missiles 32% of the time.
...
![The Second Experiment](../images/The_Second_Experiment.jpg "The Second Experiment")
{:.right}
